    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiving_bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.bloodbank')),
            ],
        ),
        migrations.AddField(
